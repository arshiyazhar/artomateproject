...
from account.models import Account, KycInfo, Categories, PostProject, Userprofile, SubCategory, Skills, \
    Bidproject, No_of_bids_for_project, Const_skills, Hirer_bid_select, User_Skills,  PostProjectImages,\
    UserPortfolioProfile, const_languages, test_languages, RaiseTicket, TicketCat,Message
...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = Userprofile
        fields = ['id', 'about_me','user_id', 'phone', 'designation', 'profile', 'portfolio',  'hourely_rate','country_id','company_name']
...
class MessageReplySerializer(serializers.ModelSerializer):
    class Meta:
        model = Message
        fields = ('id','user_id','ticket_id','ticket_route','admin_message', 'user_message', 'is_user')
...
class ProjectImageSerializer(serializers.ModelSerializer):
    class Meta:
        model = PostProjectImages
        fields = ('id','user_id','project_id','project_image')

        def save(self):
            message = PostProjectImages(
